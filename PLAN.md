...
- [ ] **MCP server.** Implement the tool surface described in §3. Start with the two or three most-used tools (`search_taxon`, `get_chunks_for_taxon`, `get_chunks_for_topic`) and grow as queries demand.
